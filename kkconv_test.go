...
func TestHiragana(t *testing.T) {
	testCases := []struct {
		...
		{
			inp: "マツエ テッペイ　めっちゃほりでぃ ﾅﾝﾊﾞかげつで まんざい みるんだょっ",
			out: "まつえ てっぺい めっちゃほりでぃ なんばかげつで まんざい みるんだょっ",
		},
	}
...
func TestKatakana(t *testing.T) {
	testCases := []struct {
		...
		{
			inp: "マツエ テッペイ　めっちゃほりでぃ ﾅﾝﾊﾞかげつで まんざい みるんだょっ",
			out: "マツエ テッペイ メッチャホリディ ナンバカゲツデ マンザイ ミルンダョッ",
		},
	}
	for _, tc := range testCases {
...
func TestChokuon(t *testing.T) {
	testCases := []struct {
		...
		{
			inp: "マツエ テッペイ　めっちゃほりでぃ ﾅﾝﾊﾞかげつで まんざい みるんだょっ",
			out: "マツエ テツペイ めつちやほりでい ナンバかげつで まんざい みるんだよつ",
		},
	}
	for _, tc := range testCases {
